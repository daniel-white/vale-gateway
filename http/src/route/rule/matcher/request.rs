...
use vg_config::http::route::rule::matcher::RequestMatcher as RequestMatcherConfig;
...
mod tests {
    use super::*;
    use crate::route::rule::matcher::header::HeaderMatcher;
    use crate::route::rule::matcher::query_param::QueryParamMatcher;
    use assertables::*;

...
use vg_core::http::filters::static_response::{HttpStaticResponseBody, HttpStaticResponseFilter, HttpStaticResponseFilterKey, HttpStaticResponseFilterRef};

pub fn convert_static_response_ref(extension_ref: &HTTPRouteRulesFiltersExtensionRef) -> HttpStaticResponseFilterRef {
    HttpStaticResponseFilterRef::builder()
        .key(&extension_ref.name)
        .build()
}

pub fn convert_static_response(
    filter: &StaticResponseFilter
) -> HttpStaticResponseFilter {
